...
"}\0";
const char* a1 = "#version 330 core\n"
"out vec4 FragColor;\n"
"void main()\n"
"{\n"
"   FragColor = vec4(1.0f, 0.5f, 0.2f, 1.0f);\n"
"}\n\0";
const char* b1 = "#version 330 core\n"
"out vec4 FragColor;\n"
"void main()\n"
"{\n"
"   FragColor = vec4(1.0f, 1.0f, 0.0f, 1.0f);\n"
"}\n\0";
std::vector< const char*> fragmentShaderSource = { a1,b1 };
int main()
{
    ...
    unsigned int fragmentShader[2],shaderprograms[2];
    for (int i = 0; i < 2; i++)
    {
    ...
    //this is not really necessary here since we will just bind the other triangle to it now but just for sake of order it will be wise to keep this call to unbind
